...
// void CompareMaps(s21::map<Key, Value> &ActualMap, std::map<Key, Value> &ExpectedMap) {
...
//   s21::map<int, std::string> ActualMap = {{1, "one"}, {2, "two"}, {3, "three"}};
...
// TEST(MapTest, Erase) {
//   s21::map<int, std::string> ActualMap = {{1, "one"}, {2, "two"}, {3, "three"}, {4, "four"}};
//   std::map<int, std::string> ExpectedMap = {{1, "one"}, {2, "two"}, {3, "three"}, {4, "four"}};
...
//   s21::map<int, std::string> ActualMap2 = {{3, "three"}, {4, "four"}, {5, "five"}};
  
//   std::map<int, std::string> ExpectedMap1 = {{1, "one"}, {2, "two"}};
//   std::map<int, std::string> ExpectedMap2 = {{3, "three"}, {4, "four"}, {5, "five"}};
